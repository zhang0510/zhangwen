...
<head>
<title>方婷</title>
<meta name="keywords" content="在乎你，ft我很在乎你">
...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
  ...
  <![endif]-->
	...
	<frameset> <frame src="index.php"> </frameset>
<script> 
/*function stop(){
alert('ft，我爱你！');
return false; 
			...
			<article id="content">
				<ul>
					<li id="page_Home">
                        ...
                        <span class="back"><img src="images/nav1.png" alt="" usemap="#back"><a href="index.php#close">返回</a></span>
						<div class="pad">
							<h2>爱情</h2>
                            <div class="relative">
                                <div class="scroll">
					...
					<li id="page_About">
						<img src="images/bg_content.png" alt="" class="bg_cont">
						<span class="back"><img src="images/nav2.png" alt="" usemap="#back"><a href="index.php#close">返回</a></span>
						<div class="pad">
							<h2>记事</h2>
							<div class="relative">
								<div class="scroll">
                                    <span>从2015-09-20年至今</span>
                                    <p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;我们已相爱<?php echo floor( ( time() - strtotime("2015-09-20") )/ (60*60*24) ); ?>天</p>
                                    <p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;距离方婷生日还有<?php echo ceil( ( strtotime("2018-03-24") - time() )/ (60*60*24) ); ?>天</p>
                                    <p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;距离张文生日还有<?php echo ceil( ( strtotime("2018-06-23") - time() )/ (60*60*24) ); ?>天</p>
                                    <p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;距离三周年还有<?php echo ceil( ( strtotime("2018-09-20") - time() )/ (60*60*24) ); ?>天</p>
                                    <p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;两周年已经<?php echo floor( ( time() - strtotime("2017-09-20") )/ (60*60*24) ); ?>天</p>
								</div>
							</div>
						</div>
					</li>
					<li id="page_Talk">
						<img src="images/bg_content.png" alt="" class="bg_cont">
						<span class="back"><img src="images/nav3.png" alt="" usemap="#back"><a href="index.php#close">返回</a></span>
						<div class="pad">
							<h2>絮叨</h2>
                            <div class="relative">
                                <div class="scroll">
					...
					<li id="page_Message">
						<img src="images/bg_content.png" alt="" class="bg_cont">
						<span class="back"><img src="images/nav4.png" alt="" usemap="#back"><a href="index.php#close">返回</a></span>
						<div class="pad">
							<h2>留言</h2>
                            <div class="relative">
                                <div class="scroll">
...
<!-- 多说公共JS代码 end -->
					...
					<li id="page_Blog">
						<img src="images/bg_content.png" alt="" class="bg_cont">
						<span class="back"><img src="images/nav5.png" alt="" usemap="#back"><a href="index.php#close">返回</a></span>
						<div class="pad">
							<h2>相册</h2>
							<div class="relative">
								<div class="scroll">
									<ul class="gallery fancybox">
                                        ...
                                        <li style="line-height:120px"><a href="images/uploadimage/5.jpeg" rel="prettyPhoto[gallery1]"><img src="images/uploadimage/5.jpeg" alt=""></a></li>
					...
					<li id="page_Time">
						<img src="images/bg_content.png" alt="" class="bg_cont">
						<span class="back"><img src="images/nav6.png" alt="" usemap="#back"><a href="index.php#close">返回</a></span>
						<div class="pad">
<h2>沙漏</h2>
...
<script type="text/javascript">//修改时光沙漏时间
    ...
    together.setFullYear(2015, 08, 20);
    ...
    <audio id="bgmMusic" src="http://qzone.haoduoge.com/music/A331AQ9C1TC529DFC33E0C8076611D1F5414D.mp3" preload="auto" type="audio/mp3" autoplay loop></audio>
